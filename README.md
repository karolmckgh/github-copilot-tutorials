...
|---|--------|-------------|-----|
| 1 | [Introduction to Copilot Chat](lessons/chat/01-introduction.md) | First steps with Copilot Chat | 25 |
| 2 | [Effective Prompting](lessons/chat/02-prompting.md) | Writing better prompts for better results | 25 |
| 3 | [Slash Commands](lessons/chat/03-slash-commands.md) | Using /fix, /explain, /tests, /doc | 25 |
| 4 | [Chat Participants](lessons/chat/04-participants.md) | @workspace, @terminal, and more | 25 |
...
Found an issue or have an idea? See [CONTRIBUTING.md](CONTRIBUTING.md) or open an issue!
